//
//  WeCsrCosSelGenViewController.m
//  AplusDr
//
...
@interface WeCsrCosSelGenViewController () {
    UITableView * sys_tableView;
}

@end

@implementation WeCsrCosSelGenViewController
        ...
        case 0:
            switch (indexPath.row) {
                case 0:
                    ...
                    if ([csrcos_selected_gender isEqualToString:@"M"]) {
                ...
                case 1:
                    ...
                    if ([csrcos_selected_gender isEqualToString:@"F"]) {
                        [cell setAccessoryType:UITableViewCellAccessoryCheckmark];
                    }
                    break;
                default:
