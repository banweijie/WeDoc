...
#import "WeInpSkiViewController.h"
#import "WeAppDelegate.h"

@interface WeInpSkiViewController () {
    UITableView * sys_tableView;
    UITextView * user_skills_input;
}

@end

@implementation WeInpSkiViewController
...
{
    if (path.section == 0 && path.row == 0) [user_skills_input becomeFirstResponder];
    return nil;
}
// 选中某个Cell触发的事件
        ...
        case 0:
            switch (indexPath.row) {
                case 0:
                    ...
                    [cell addSubview:user_skills_input];
                    break;
                default:
                    break;
            }
...
- (void)viewDidLoad
{
    ...
    [user_skills_input becomeFirstResponder];
}
