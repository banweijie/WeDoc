...
@interface WeFgtInpViewController ()
{
...
@implementation WeFgtInpViewController
...
- (void)api_user_checkVerificationCode {
    ...
    [WeAppDelegate postToServerWithField:@"user" action:@"checkVerificationCode"
                              parameters:@{
                                 ...
                                 success:^(id response) {
                                     WeFgtSetPaswdViewController * vc = [[WeFgtSetPaswdViewController alloc] init];
