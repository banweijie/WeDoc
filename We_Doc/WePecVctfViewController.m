...
#import "WePecVctfViewController.h"
#import "WeAppDelegate.h"
#import <UIImageView+AFNetworking.h>

@interface WePecVctfViewController () {
    UITableView * sys_tableView;
    UIImageView * user_Photo_view;
    UITextField * user_Id_input;
}

@end

@implementation WePecVctfViewController
...
- (void)user_save_onpress:(id)sender {
    NSString *urlString =[NSString stringWithFormat:@"%@?fileFileName=111.jpg&fileType=pc",yijiarenUrl(@"doctor", @"updateCert")];
    ...
    NSData * imageData = UIImageJPEGRepresentation(user_Photo_view.image, 1.0f);
