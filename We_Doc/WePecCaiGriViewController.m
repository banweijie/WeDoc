...
#import "WePecCaiGriViewController.h"
#import "WeAppDelegate.h"

@interface WePecCaiGriViewController () {
    UITableView * sys_tableView;
    UITextView * user_notification_input;
}

@end

@implementation WePecCaiGriViewController
...
- (void) user_save_onpress:(id)sender {
    ...
    NSString *parasString = [NSString stringWithFormat:@"groupIntro=%@", [user_notification_input.text urlencode]];
